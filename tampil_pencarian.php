...
<div class="row">
    ...
    ?>
        ...
        <?php
        // sql statement untuk menampilkan data dari tabel "tbl_pegawai" berdasarkan "kata_kunci"
        $query = $mysqli->query("SELECT id_pegawai, divisi, nama_lengkap, foto_profil FROM pegawai 
                                WHERE id_pegawai LIKE '%$kata_kunci%' OR nama_lengkap LIKE '%$kata_kunci%'
        ...
        // jika data pegawai tidak ada
            ...
            <div class="col-12">
                ...
                Data pegawai dengan kata kunci <span class="text-primary fst-italic px-2">"<?php echo $kata_kunci; ?>"</span> tidak ditemukan.
            </div>
    <?php
        }
    }
