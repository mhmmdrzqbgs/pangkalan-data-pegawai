...
<?php
// mengecek data GET "id_pegawai"
if (isset($_GET['id'])) {
    // ambil data GET dari tombol ubah
    $id_pegawai = $_GET['id'];

    // sql statement untuk menampilkan data dari tabel "tbl_siswa" berdasarkan "id_pegawai"
    $query = $mysqli->query("SELECT * FROM pegawai WHERE id_pegawai='$id_pegawai'")
...
<div class="bg-white rounded-4 shadow-sm p-4 mb-5">
    ...
    <div class="alert alert-primary rounded-4 mb-5" role="alert">
        <i class="fa-solid fa-pen-to-square me-2"></i> Ubah Data Pegawai
    </div>
    <!-- form ubah data -->
            ...
            <div class="col-xl-6">
                <div class="row g-0">
                    ...
                    <div class="mb-3 col-xl-6 pe-xl-3">
                        ...
                        <input type="text" name="tanggal_masuk" class="form-control datepicker" autocomplete="off" value="<?php echo date('d-m-Y', strtotime($data['tanggal_masuk'])); ?>" required>
