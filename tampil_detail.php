...
if (isset($_GET['id'])) {
    ...
    // sql statement untuk menampilkan data dari tabel "pegawai" berdasarkan "id_pegawai"
...
<div class="bg-white rounded-4 shadow-sm p-4 mb-5">
    ...
    <div class="alert alert-primary rounded-4 mb-5" role="alert">
        <i class="fa-solid fa-list-ul me-2"></i> Detail Data Pegawai
    </div>
    <!-- tampilkan data -->
            ...
            <div class="table-responsive">
                <table class="table table-striped lh-lg">
                    ...
                    <tr>
                        <td>Tanggal Masuk</td>
                        <td>:</td>
                        <td><?php echo tanggal_indo($data['tanggal_masuk']); ?></td>
                    </tr>
                    <tr>
                        <td>Divisi</td>
                        <td>:</td>
